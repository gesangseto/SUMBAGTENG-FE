...
(function () {
  ...
  function Va(g, m, v) {
    "millisecond" === v
      ? g.setMilliseconds(g.getMilliseconds() + 1 * m)
      : "second" === v
      ? g.setSeconds(g.getSeconds() + 1 * m)
      : "minute" === v
      ? g.setMinutes(g.getMinutes() + 1 * m)
      : "hour" === v
      ? g.setHours(g.getHours() + 1 * m)
      : "day" === v
      ? g.setDate(g.getDate() + 1 * m)
      : "week" === v
      ? g.setDate(g.getDate() + 7 * m)
      : "month" === v
      ? g.setMonth(g.getMonth() + 1 * m)
      : "year" === v && g.setFullYear(g.getFullYear() + 1 * m);
    return g;
  }
  function X(g, m) {
    var v = !1;
    0 > g && ((v = !0), (g *= -1));
    g = "" + g;
    for (m = m ? m : 1; g.length < m; ) g = "0" + g;
    return v ? "-" + g : g;
  }
  function Fa(g) {
    if (!g) return g;
    g = g.replace(/^\s\s*/, "");
    for (var m = /\s/, v = g.length; m.test(g.charAt(--v)); );
  ...
  function P(g) {
    var m = ((g & 16711680) >> 16).toString(16),
  ...
  function Wa(g, m, v) {
    ...
    if (isNaN(w)) {
      try {
        ...
        w = Math.round(wa.offsetHeight ?? 10);
  ...
  function Ya(g, m, v) {
    ...
    return m ? (g[0] << 16) | (g[1] << 8) | g[2] : 0;
  }
  function la(g, m, v) {
    return g in m ? m[g] : v[g];
  }
  function La(g, m, v) {
    if (w && Za) {
  ...
  function ga(g, m) {
    for (var v in m) g.style[v] = m[v];
  }
  function va(g, m, v) {
    m.getAttribute("state") ||
      ((m.style.backgroundColor = g.toolbar.itemBackgroundColor),
    ...
    m.getAttribute("state") !== v &&
      ...
      m.setAttribute("title", g._cultureInfo[v + "Text"]),
      (m.innerHTML =
  ...
  function Ka() {
    for (var g = null, m = 0; m < arguments.length; m++)
      (g = arguments[m]), g.style && (g.style.display = "inline");
  }
  function ua() {
    for (var g = null, m = 0; m < arguments.length; m++)
      (g = arguments[m]) && g.style && (g.style.display = "none");
  }
  function Ra(g, m, v, s, w) {
    if (null === g || "undefined" === typeof g)
      return "undefined" === typeof v ? m : v;
    g =
      parseFloat(g.toString()) * (0 <= g.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof s &&
      ((g = Math.min(s, g)), "undefined" !== typeof w && (g = Math.max(w, g)));
    return !isNaN(g) && g <= m && 0 <= g ? g : "undefined" === typeof v ? m : v;
  }
  function U(g, m, v, w, qa) {
    this._defaultsKey = g;
  ...
  function Sa(g, m) {
    Sa.base.constructor.call(this, "Toolbar", "toolbar", m, null, g);
    this.chart = g;
  ...
  function ya(g, m) {
    ya.base.constructor.call(this, "Title", "title", m, null, g);
    this.chart = g;
    this.canvas = g.canvas;
    this.ctx = this.chart.ctx;
  ...
  function Ha(g, m, v) {
    Ha.base.constructor.call(this, "Subtitle", "subtitles", m, v, g);
    this.chart = g;
    this.canvas = g.canvas;
    this.ctx = this.chart.ctx;
  ...
  var fb = (function () {
        ...
        if (((m = F[K]), "." === m && 0 > N)) N = K;
          ...
          if ("%" === m) E *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (S = !0);
          0 > N
            ? (M.push(m), "#" === m || "0" === m ? P++ : "," === m && R++)
            : (H.push(m), ("#" !== m && "0" !== m) || J++);
        }
      S &&
        ((m = Math.floor(g)),
        (F = -Math.floor(Math.log(g) / Math.LN10 + 1)),
        (U = 0 === g ? 0 : 0 === m ? -(P + F) : String(m).length - P),
        (E /= Math.pow(10, U)));
      0 > N && (N = K);
      E = (g * E).toFixed(J);
      m = E.split(".");
    ...
    Na = function (g) {
      ...
      g.offsetX || 0 === g.offsetX
        ? ((m = g.offsetX), (v = g.offsetY))
        : g.layerX || 0 == g.layerX
        ? ((m = g.layerX), (v = g.layerY))
        : ((m = g.pageX - g.target.offsetLeft),
    ...
    Ma = 1,
    ka = Za ? Qa / Ma : 1,
    ca = function (g, m, v, s, w, y, E, F, N, M, P, S, H) {
      "undefined" === typeof H && (H = 1);
      E = E || 0;
      F = F || "black";
      var J = 15 < s - m && 15 < w - v ? 8 : 0.35 * Math.min(s - m, w - v);
      g.beginPath();
      g.moveTo(m, v);
      g.save();
      g.fillStyle = y;
      g.globalAlpha = H;
      g.fillRect(m, v, s - m, w - v);
      g.globalAlpha = 1;
      0 < E &&
        ((H = 0 === E % 2 ? 0 : 0.5),
        g.beginPath(),
        ...
        (g.strokeStyle = F),
        g.moveTo(m, v),
        g.rect(m - H, v - H, s - m + 2 * H, w - v + 2 * H),
        g.stroke());
      g.restore();
      !0 === N &&
        (g.save(),
        ...
        g.lineTo(s, v),
        g.closePath(),
        (E = g.createLinearGradient((s + m) / 2, v + J, (s + m) / 2, v)),
        E.addColorStop(0, y),
      ...
      !0 === M &&
        ...
        g.lineTo(s, w),
        g.closePath(),
        (E = g.createLinearGradient((s + m) / 2, w - J, (s + m) / 2, w)),
        E.addColorStop(0, y),
        E.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (g.fillStyle = E),
        g.fill(),
      ...
      !0 === P &&
        ...
        g.lineTo(m, w),
        g.closePath(),
        (E = g.createLinearGradient(m + J, (w + v) / 2, m, (w + v) / 2)),
        E.addColorStop(0, y),
  ...
  U.prototype.setOptions = function (g, m) {
    if (pa[this._defaultsKey]) {
      ...
      for (w in s)
        "publicProperties" !== w &&
          s.hasOwnProperty(w) &&
          (this[w] = g && w in g ? g[w] : m && w in m ? m[w] : s[w]);
  ...
  U.prototype.get = function (g) {
    ...
    if (
      m.hasOwnProperty(g) ||
      (m.publicProperties && m.publicProperties.hasOwnProperty(g))
    )
      return this[g];
    window.console &&
      window.console.log(
  ...
  U.prototype.set = function (g, m, s) {
    s = "undefined" === typeof s ? !0 : s;
    var w = pa[this._defaultsKey];
    if ("options" === g) this.createUserOptions(m);
    else if (
      w.hasOwnProperty(g) ||
      (w.publicProperties &&
  ...
  U.prototype.addTo = function (g, m, s, w) {
  ...
  U.prototype.updateOption = function (g) {
    ...
    this.themeOptions = w;
    g in m &&
      (y = g in this.options ? this.options[g] : w && g in w ? w[g] : m[g]);
  ...
  U.prototype.addEventListener = function (g, m, s) {
    g &&
      m &&
      ((this._eventListeners[g] = this._eventListeners[g] || []),
      this._eventListeners[g].push({ context: s || this, eventHandler: m }));
  };
  U.prototype.removeEventListener = function (g, m) {
    if (g && m && this._eventListeners[g])
  ...
  U.prototype.dispatchEvent = function (g, m, s) {
    if (g && this._eventListeners[g]) {
      m = m || {};
      for (var w = this._eventListeners[g], y = 0; y < w.length; y++)
        w[y].eventHandler.call(w[y].context, m);
    }
    "function" === typeof this[g] && this[g].call(s || this.chart, m);
  };
  Da.prototype.registerSpace = function (g, m) {
    "top" === g
      ...
      : "right" === g && (this._rightOccupied += m.width);
  };
  Da.prototype.unRegisterSpace = function (g, m) {
    "top" === g
      ? (this._topOccupied -= m.height)
      : "bottom" === g
      ? (this._bottomOccupied -= m.height)
  ...
  ia.prototype._getLineWithWidth = function (g, m, s) {
    g = String(g);
    ...
    m = !0;
    if (E.length === g.length || " " === g[E.length]) m = !1;
    m &&
      ((g = E.split(" ")),
      1 < g.length && g.pop(),
      (E = g.join(" ")),
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      var g = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        m = g.layoutManager.getFreeSpace(),
        w = m.x1,
        y = m.y1,
        F = 0,
        J = 0,
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = m.y2 - 2 - M.height), (H = "bottom")),
          "left" === this.horizontalAlign
            ? (w = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = m.x1 + m.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - E),
  ...
  Ta.prototype.get = function (g, m) {
    var w = null;
    0 < this.pool.length
      ? ((w = this.pool.pop()), La(w, g, m))
      : (w = ta(g, m));
    return w;
  };
  ...
  oa(Ia, U);
  var Oa = {
    addTheme: function (g, m) {
      ab[g] = m;
    },
    addColorSet: function (g, m) {
      za[g] = m;
    },
    addCultureInfo: function (g, m) {
      Ja[g] = m;
    },
    formatNumber: function (g, m, w) {
      w = w || "en";
      if (Ja[w]) return ea(g, m || "#,##0.##", new Ia(w));
      throw "Unknown Culture Name";
    },
    formatDate: function (g, m, w) {
      w = w || "en";
      if (Ja[w]) return Aa(g, m || "DD MMM YYYY", new Ia(w));
      throw "Unknown Culture Name";
    },
  };
  ...
  y = Oa.Chart = (function () {
    ...
    function y(a, d, c, b, e, f, p, t, B, k) {
      ...
      l =
        0 < p.trimLength
          ? Math.abs((l * p.trimLength) / 100)
          : Math.abs(l - p.length);
      B ? ((c += l / 2), (e -= l / 2)) : ((d += l / 2), (b -= l / 2));
      var l = 1 === Math.round(p.thickness) % 2 ? 0.5 : 0,
      ...
      a.beginPath();
      B && 0 < t.thickness
        ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - n),
          a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - n))
        : 0 < t.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - n, c + p.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - n, e - p.thickness / 2));
      a.stroke();
          ...
          l._animator.animate(
            ...
            function (a) {
              ...
              l.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(l.width * ka),
                Math.floor(l.height * ka),
                0,
                0,
                l.width,
                l.height
            ...
            function () {
              ...
              for (var a = 0; a < l.plotInfo.plotTypes.length; a++)
                for (
                  var e = l.plotInfo.plotTypes[a], d = 0;
    ...
    m.prototype.categoriseDataSeries = function () {
      for (var a = "", d = 0; d < this.data.length; d++)
        if (
          ...
          for (p = 0; p < c.plotUnits.length; p++)
            if (
              c.plotUnits[p].axisYType === a.axisYType &&
              c.plotUnits[p].axisXType === a.axisXType &&
              c.plotUnits[p].axisYIndex === a.axisYIndex &&
              c.plotUnits[p].axisXIndex === a.axisXIndex
            ) {
              f = !0;
              e = c.plotUnits[p];
              break;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          c = this.plotInfo.plotTypes[d], p = a = 0;
          p < c.plotUnits.length;
          p++
        )
          (c.plotUnits[p].previousDataSeriesCount = a),
            (a += c.plotUnits[p].dataSeriesIndexes.length);
    };
    ...
    m.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0;
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          var n = this.data[a.dataSeriesIndexes[l]],
            q = 0,
            h = !1,
            r = !1,
            g;
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            if (b < m && !h) null !== n.dataPoints[q].y && (g = b);
            else {
              if (!h && ((h = !0), 0 < q)) {
                q -= 2;
                continue;
        ...
        for (
          ...
          for (n = 0; n < l.dataPoints.length; n++) {
            ...
            l.dataPoints[n].x.getTime
              ? ((f = !0), (b = l.dataPoints[n].x.getTime()))
              : (b = l.dataPoints[n].x);
            e = s(l.dataPoints[n].y) ? null : l.dataPoints[n].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            if (0 < n) {
              if (a.axisX.logarithmic) {
                var u = b / l.dataPoints[n - 1].x;
                1 > u && (u = 1 / u);
                c.minDiff > u && 1 !== u && (c.minDiff = u);
              } else
                (u = b - l.dataPoints[n - 1].x),
                  0 > u && (u *= -1),
            ...
            if (b < g && !q) null !== e && (r = b);
              ...
              if (b > m && !h) h = !0;
              else if (b > m && h) continue;
              l.dataPoints[n].label &&
                (a.axisX.labels[b] = l.dataPoints[n].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
        ...
        for (
          ...
          for (l = 0; l < k.dataPoints.length; l++) {
            ...
            k.dataPoints[l].x.getTime
              ? ((t = !0), (b = k.dataPoints[l].x.getTime()))
              : (b = k.dataPoints[l].x);
              ...
              if (((l = k[t].max), isFinite(l)))
                for (; t < k.length - 1; )
                  if (((B = k[t + 1].min), isFinite(B))) {
                    n = B - l;
                    n > b && f.push({ diff: n, start: l, end: B });
                    break;
                  } else t++;
          ...
          if (this.panEnabled)
            (e = {
              ...
              (p._panTimerId = setTimeout(
                (function (b, c, e, f) {
                  return function () {
                    p._zoomPanToSelectedRegion(b, c, e, f, !0) &&
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (p = 0; p < k.length; p++) {
        var n = k[p],
          ...
          h = n.convertPixelToValue({ x: c, y: b });
        if (q > h)
          var r = h,
            h = q,
            q = r;
        ...
        if (isFinite(n.dataInfo.minDiff))
          if (
            ...
            B.push(n), l.push({ val1: q, val2: h }), (t = !0);
          else if (!e) {
            t = !1;
            break;
          }
      }
      return { isValid: t, axesWithValidRange: B, axesRanges: l };
    };
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var l = this._indexLabels[a],
          n = l.chartType.toLowerCase(),
          q,
          h,
          p = la("indexLabelFontColor", l.dataPoint, l.dataSeries),
          r = la("indexLabelFontSize", l.dataPoint, l.dataSeries),
          t = la("indexLabelFontFamily", l.dataPoint, l.dataSeries),
          B = la("indexLabelFontStyle", l.dataPoint, l.dataSeries),
          k = la("indexLabelFontWeight", l.dataPoint, l.dataSeries),
          g = la("indexLabelBackgroundColor", l.dataPoint, l.dataSeries);
        q = la("indexLabelMaxWidth", l.dataPoint, l.dataSeries);
        h = la("indexLabelWrap", l.dataPoint, l.dataSeries);
        var m = la("indexLabelLineDashType", l.dataPoint, l.dataSeries),
          u = la("indexLabelLineColor", l.dataPoint, l.dataSeries),
          x = s(l.dataPoint.indexLabelLineThickness)
            ? s(l.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        if (
          ...
          A = this.getPercentAndTotal(l.dataSeries, l.dataPoint);
        ...
        var D = l.dataPoint.indexLabelFormatter
          ...
          ? l.dataSeries.indexLabelFormatter(C)
          ...
          : null;
        if (null !== D && "" !== D) {
          var A = la("indexLabelPlacement", l.dataPoint, l.dataSeries),
            C = la("indexLabelOrientation", l.dataPoint, l.dataSeries),
            z = la("indexLabelTextAlign", l.dataPoint, l.dataSeries),
            v = l.direction,
            e = l.dataSeries.axisX,
            f = l.dataSeries.axisY,
            y = !1,
            g = new ia(d, {
              x: 0,
              y: 0,
          ...
          g.measureText();
          l.dataSeries.indexLabelMaxWidth = g.maxWidth;
          if ("stackedarea100" === n) {
            if (
              l.point.x < c.x1 ||
              l.point.x > c.x2 ||
            ...
            if (
              l.dataPoint.x < e.viewportMinimum ||
              l.dataPoint.x > e.viewportMaximum ||
              Math.max.apply(null, l.dataPoint.y) < f.viewportMinimum ||
              Math.min.apply(null, l.dataPoint.y) > f.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("line") ||
            ...
            if (
              l.dataPoint.x < e.viewportMinimum ||
              l.dataPoint.x > e.viewportMaximum ||
              l.dataPoint.y < f.viewportMinimum ||
              l.dataPoint.y > f.viewportMaximum
            )
              continue;
          } else if (
            0 <= n.indexOf("column") ||
            "waterfall" === n ||
            ("error" === n && !l.axisSwapped)
          ) {
            if (
              l.dataPoint.x < e.viewportMinimum ||
              l.dataPoint.x > e.viewportMaximum ||
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            q = l.point.x - ("horizontal" === C ? B / 2 : B / 2 - r / 2);
            "inside" !== A
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((h =
                      l.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b),
                    h < e &&
                      ((h =
                        "auto" === A
                          ? Math.max(l.point.y, e) + r / 2 + t
                          : e + r / 2 + t),
                      (y = h + k > l.point.y)))
                  : ((h = l.point.y + r / 2 + t + b),
                    h > f - k &&
                      ((h =
                        "auto" === A
                          ? Math.min(l.point.y, f) + r / 2 - k - t
                          : f + r / 2 - k),
                      (y = h < l.point.y))))
              : ((e = Math.max(l.bounds.y1, c.y1)),
                (f = Math.min(l.bounds.y2, c.y2 - k + r / 2)),
                (b =
                  0 <= n.indexOf("range") || "error" === n
                    ? 0 < v
                      ? Math.max(l.bounds.y1, c.y1) + r / 2 + t
                      : Math.min(l.bounds.y2, c.y2) + r / 2 - k + t
                    : (Math.max(l.bounds.y1, c.y1) +
                      ...
                      ("horizontal" === C ? t : 0)),
                0 < v
                  ? ((h = Math.max(l.point.y, b)),
                    h < e &&
                      ("bubble" === n || "scatter" === n) &&
                      (h = Math.max(l.point.y - k - t, c.y1 + t)))
                  : ((h = Math.min(l.point.y, b)),
                    h > f - k - t &&
                      ("bubble" === n || "scatter" === n) &&
                      (h = Math.min(l.point.y + t, c.y2 - k - t))),
                (h = Math.min(h, f)));
          } else
            0 <= n.indexOf("line") ||
            0 <= n.indexOf("area") ||
                ...
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ((q =
                          "auto" === A ? Math.max(l.point.x, e) + p : e + p),
                        (y = q + B > l.point.x)))
                    : ((q =
                        l.point.x + ("horizontal" === C ? 0 : r / 2) + p + b),
                      q > f - B - p - b &&
                        ((q =
                          "auto" === A
                            ? Math.min(l.point.x, f) -
                              ("horizontal" === C ? B : B / 2) -
                              p
                            : f - B - p),
                        (y = q < l.point.x))))
                : ((e = Math.max(l.bounds.x1, c.x1)),
                  Math.min(l.bounds.x2, c.x2),
                  (b =
                    0 <= n.indexOf("range") || "error" === n
                      ? 0 > v
                        ? Math.max(l.bounds.x1, c.x1) + r / 2 + p
                        : Math.min(l.bounds.x2, c.x2) -
                          B / 2 -
                          p +
                          ("horizontal" === C ? 0 : r / 2)
                  ...
                  (q =
                    0 > v
                      ? Math.max(l.point.x, b) -
                        ("horizontal" === C ? B / 2 : 0)
                      : Math.min(l.point.x, b) - B / 2),
                  (q = Math.max(q, e)));
          "vertical" === C && (h += k - r / 2);
          g.x = q;
          g.y = h;
          ...
          x &&
            ...
            d.beginPath(),
            d.moveTo(l.point.x, l.point.y),
            0 <= n.indexOf("bar") || ("error" === n && l.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < l.direction ? -p : B + p) +
                    ("vertical" === C ? -r / 2 : 0),
              ...
              : 0 <= n.indexOf("column") || ("error" === n && !l.axisSwapped)
              ? d.lineTo(
                  q + B / 2 - ("horizontal" === C ? 0 : r / 2),
                  h +
                    ("vertical" === C
                      ? (h - k < l.point.y ? 0 : -k) + t
                      : (h - r / 2 < l.point.y ? k : 0) - r / 2)
                )
              : d.lineTo(
                  q + B / 2 - ("horizontal" === C ? 0 : r / 2),
                  h +
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (l = this._indexLabels[a]),
          (g = la("indexLabelBackgroundColor", l.dataPoint, l.dataSeries)),
          (l.dataSeries.indexLabelBackgroundColor = s(g)
            ? w
              ? "transparent"
              : null
            : g);
    ...
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          c.beginPath();
          if (0 < l.length) {
            for (var C = !1, u = 0; u < l.length; u++)
              if (
                ((x = l[u].x.getTime ? l[u].x.getTime() : l[u].x),
                !(
                ...
                if ("number" !== typeof l[u].y)
                  0 < u &&
                    !(k.connectNullData || C || m) &&
                    (c.stroke(), w && b.stroke()),
                    (C = !0);
                else {
                  x = a.axisX.convertValueToPixel(x);
                  s = a.axisY.convertValueToPixel(l[u].y);
                  ...
                  u < l.length - 1 &&
                    (g !== (l[u].lineColor || r) ||
                      n !== (l[u].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, s),
                    (g = l[u].lineColor || r),
                    ...
                    c.setLineDash &&
                      (l[u].lineDashType
                        ? ((n = l[u].lineDashType),
                          c.setLineDash(N(n, k.lineThickness)))
                        : ((n = k.lineDashType), c.setLineDash(h))));
                  if (0 < l[u].markerSize || 0 < k.markerSize) {
                  ...
                  (l[u].indexLabel ||
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: k,
                      point: { x: x, y: s },
                      direction: 0 > l[u].y === a.axisY.reversed ? 1 : -1,
                      color: r,
                    });
                }
            c.stroke();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            for (var C = !1, u = 0; u < l.length; u++)
              if (
                ((x = l[u].getTime ? l[u].x.getTime() : l[u].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !C))
    ...
    m.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          b.beginPath();
          if (0 < l.length)
            for (x = !1, m = 0; m < l.length; m++)
              if (
                ((u = l[m].getTime ? l[m].x.getTime() : l[m].x),
                !(
                ...
                if ("number" !== typeof l[m].y)
                  ...
                  x = a.axisY.convertValueToPixel(l[m].y);
                  ...
                  m < l.length - 1 &&
                    (g !== (l[m].lineColor || r) ||
                      n !== (l[m].lineDashType || k.lineDashType)) &&
                    ((g = l[m].lineColor || r),
                  ...
                  if (0 < l[m].markerSize || 0 < k.markerSize) {
                    var D = k.getMarkerProperties(m, u, x, b);
                    p.push(D);
                    C = P(C);
                    w &&
                      p.push({
              ...
              if (
                ...
                p = a.axisX.reversed
                  ? (p +
                      ...
                      (a.previousDataSeriesCount + l) * n) <<
                    0
                  : (p -
                      (a.plotType.totalDataSeries * n) / 2 +
                      (a.previousDataSeriesCount + l) * n) <<
                    0;
                var m = a.axisX.reversed ? (p - n) << 0 : (p + n) << 0,
                  u;
                0 <= r[f].y ? (u = k) : ((u = t), (t = k));
                t > u && ((b = t), (t = u), (u = b));
                b = r[f].color
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (l - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                    0,
                  C = (s + h) << 0,
                  D;
                if (
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < u.length)
            for (
              var x = 5 < h && m.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (B[b] = n + ("undefined" !== typeof B[b] ? B[b] : 0)),
                    (D = a.axisY.convertValueToPixel(B[b])),
                    (n = p[b] ? p[b] : q),
                    (p[b] = D);
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                b = r[f].color
                  ? r[f].color
                  : h._colorSet[f % h._colorSet.length];
                ca(c, u, t, p, m, b, 0, null, g, !1, !1, !1, h.fillOpacity);
                b = h.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
              ...
              if (
                ...
                if (
                  ...
                  (t[b] = u[k].y + (t[b] ? t[b] : 0)),
                    0 < t[b] &&
                      ((D = f[b] ? f[b] : q),
                      (f[b] = l = a.axisY.convertValueToPixel(t[b])));
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= u[k].y
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)),
                    (l = p[b] ? p[b] : q),
                    (p[b] = D = a.axisY.convertValueToPixel(B[b]));
                else if (
                  ((l = a.axisY.convertValueToPixel(u[k].y)), 0 <= u[k].y)
                ) {
                  var z = f[b] ? f[b] : 0;
                  D = q + z;
                  l += z;
                ...
                b = u[k].color
                  ? u[k].color
                  : m._colorSet[k % m._colorSet.length];
                ca(c, D, s, l, C, b, 0, null, x, !1, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = A + (B[b] ? B[b] : 0)),
                    (l = p[b] ? p[b] : q),
                    (p[b] = A = a.axisY.convertValueToPixel(B[b]));
                else if (((l = a.axisY.convertValueToPixel(A)), 0 <= u[k].y)) {
                  var z = f[b] ? f[b] : 0;
                  A = q + z;
                  l += z;
                  a.dataSeriesIndexes.length - 1 === r &&
                ...
                b = u[k].color
                  ? u[k].color
                  : m._colorSet[k % m._colorSet.length];
                ca(c, A, C, l, D, b, 0, null, s, !1, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        D &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (p.lineTo(m, C), p.lineTo(D.x, C), p.closePath(), p.fill()),
          f.beginPath(),
          f.moveTo(m, u),
          p.beginPath(),
          p.moveTo(m, u),
            ...
            for (var ja = !0; g < r.length; g++)
              if (
                ...
                if ("number" !== typeof r[g].y)
                  ...
                  g < r.length - 1 &&
                    (y !== (r[g].lineColor || v) ||
                      c !== (r[g].lineDashType || h.lineDashType)) &&
                    (b(),
                    (y = r[g].lineColor || v),
                    (f.strokeStyle = y),
                    f.setLineDash &&
                      (r[g].lineDashType
                        ? ((c = r[g].lineDashType),
                          f.setLineDash(N(c, h.lineThickness)))
                        : ((c = h.lineDashType), f.setLineDash(aa))));
                  ...
                  0 !== r[g].markerSize &&
                    ...
                    ((s = h.getMarkerProperties(g, m, u, f)),
                    B.push(s),
                    (Y = P(Y)),
                    w &&
                      B.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          var p = [],
            ...
            s = [];
          if (0 < n.length) {
            var A = l._colorSet[q % l._colorSet.length],
              C = (l.lineColor = l.options.lineColor || A),
              D = C;
            b.fillStyle = A;
            b.strokeStyle = C;
            ...
            var z = "solid";
            if (b.setLineDash) {
              var y = N(l.nullDataLineDashType, l.lineThickness),
                z = l.lineDashType,
                E = N(z, l.lineThickness);
              b.setLineDash(E);
            }
            for (r = !1; q < n.length; q++)
              if (
                ...
                if ("number" !== typeof n[q].y)
                  ...
                  q < n.length - 1 &&
                    (D !== (n[q].lineColor || C) ||
                      z !== (n[q].lineDashType || l.lineDashType)) &&
                    ((D = n[q].lineColor || C),
                  ...
                  if (
                    0 !== n[q].markerSize &&
                    (0 < n[q].markerSize || 0 < l.markerSize)
                  ) {
                    var aa = l.getMarkerProperties(q, h, r, b);
                    p.push(aa);
                    Q = P(Q);
                    w &&
                      p.push({
              ...
              if (
                ...
                "number" !== typeof r[g].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(s)),
                    ...
                    0 !== r[g].markerSize &&
                      (0 < r[g].markerSize || 0 < h.markerSize) &&
                      ((Y = h.getMarkerProperties(g, m, u, f)),
                      B.push(Y),
                      (s = P(s)),
                      w &&
                        B.push({
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < z.markerSize) &&
                    ((ba = z.getMarkerProperties(q, h, r, b)),
                    t.push(ba),
                    (f = P(G)),
                    w &&
                      t.push({
              ...
              if (
                ...
                var h = q[e].z,
                  s =
                    ...
                    Math.max(
                      Math.sqrt(
                        (t === g ? m / 2 : r + ((m - r) / (t - g)) * (h - g)) /
                          Math.PI
                      ) << 0,
                      1
                    ),
                  h = n.getMarkerProperties(e, c);
                h.size = s;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            ...
            for (var n = 0, q = 0, e = 0; e < l.length; e++)
              if (
                ((f = l[e].getTime ? (f = l[e].x.getTime()) : (f = l[e].x)),
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof l[e].y)
                ...
                f = a.axisX.convertValueToPixel(f);
                p = a.axisY.convertValueToPixel(l[e].y);
                var h = k.getMarkerProperties(e, f, p, c);
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.clip();
        w && (b.beginPath(), b.rect(p.x1, p.y1, p.width, p.height), b.clip());
          ...
          if (0 < x.length)
            for (
              ...
              if (
                ...
                l = a.axisY.convertValueToPixel(x[t].y[1]);
                ...
                (x[t].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[t],
                    dataSeries: u,
                    point: { x: C + (D - C) / 2, y: a.axisY.reversed ? n : l },
                    direction: 1,
                    bounds: {
                      x1: C,
                      y1: Math.min(l, n),
          ...
          if (0 < A.length)
            for (
              ...
              if (
                ...
                l = a.axisY.convertValueToPixel(A[p].y[2]);
                ...
                0 < aa &&
                  ...
                  (c.strokeStyle = Q),
                  (c.lineWidth = aa),
                  c.moveTo((t - Y / 2) << 0, n - fa),
                  c.lineTo((t + Y / 2) << 0, n - fa),
                  c.stroke(),
                  c.moveTo((t - Y / 2) << 0, g + fa),
                  c.lineTo((t + Y / 2) << 0, g + fa),
                  c.stroke());
                c.restore();
                w &&
                  ((e = P(O)),
                  ...
                  0 < ba &&
                    (b.moveTo(t - E - G, k),
                    b.lineTo(t - E - G, Math.max(g, n)),
                    b.stroke(),
                    b.moveTo(t - E - G, Math.min(g, n)),
                    b.lineTo(t - E - G, l),
                    b.stroke()),
                  ca(
                    b,
          ...
          if (0 < h.length)
            for (
              ...
              if (
                ...
                ca(c, m, p, v, t, b, 0, b, r, r, !1, !1, q.fillOpacity);
                b = P(u);
                w &&
                  ca(
                    this._eventManager.ghostCtx,
              ...
              if (
                ...
                b
                  ...
                  : ((l = a.axisX.reversed
                      ...
                      : (g - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0),
                    (n = a.axisX.reversed ? (l - u) << 0 : (l + u) << 0));
                !b && q > h && ((ja = q), (q = h), (h = ja));
                b && l > n && ((ja = l), (l = n), (n = ja));
                ja = C.dataPointIds[t];
                ...
                w && y(this._eventManager.ghostCtx, l, q, n, h, e, Q, aa, b);
                if (
                  D[t].indexLabel ||
                  C.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (D[t].y[1] >= D[t].y[0] ? l : n) : l + (n - l) / 2,
                      y: b ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? h : q,
                    },
                      ...
                      point: {
                        x: b
                          ? D[t].y[1] >= D[t].y[0]
                            ...
                            : l
                          : l + (n - l) / 2,
                        y: b ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : h,
                      },
                      direction: D[t].y[1] >= D[t].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(l, n) : l,
              ...
              if (
                ...
                g = a.axisX.reversed
                  ? (g +
                      ...
                      (a.previousDataSeriesCount + n) * l) <<
                    0
                  : (g -
                      (a.plotType.totalDataSeries * l) / 2 +
                      (a.previousDataSeriesCount + n) * l) <<
                    0;
                var v = a.axisX.reversed ? (g - l) << 0 : (g + l) << 0;
                p > t && ((b = p), (p = t), (t = b));
                b = r[f].color
                  ? r[f].color
                  : h._colorSet[f % h._colorSet.length];
                ca(c, p, g, t, v, b, 0, null, m, !1, !1, !1, h.fillOpacity);
                b = h.dataPointIds[f];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
    ...
    m.prototype.renderRangeArea = function (a) {
      function d() {
        if (x) {
          for (var a = null, c = g.length - 1; 0 <= c; c--)
            (a = g[c]), b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = l.fillOpacity;
          b.fill();
          b.globalAlpha = 1;
          ...
          if (0 < l.lineThickness) {
            b.beginPath();
            b.moveTo(a.x, a.y2);
            for (c = 0; c < g.length; c++) (a = g[c]), b.lineTo(a.x, a.y2);
            b.moveTo(g[0].x, g[0].y1);
            for (c = 0; c < g.length; c++) (a = g[c]), b.lineTo(a.x, a.y1);
            b.stroke();
          }
          b.beginPath();
          b.moveTo(r, m);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var f = [],
            ...
            x = null;
          if (0 < n.length) {
            var v = l._colorSet[h % l._colorSet.length],
              C = (l.lineColor = l.options.lineColor || v),
              D = C;
            b.fillStyle = v;
            b.strokeStyle = C;
            b.lineWidth = l.lineThickness;
            ...
            for (var Q = !0; h < n.length; h++)
              if (
                ...
                if (
                  ...
                  m = a.axisY.convertValueToPixel(n[h].y[0]);
                  ...
                  h < n.length - 1 &&
                    (D !== (n[h].lineColor || C) ||
                      z !== (n[h].lineDashType || l.lineDashType)) &&
                    (d(),
                    (D = n[h].lineColor || C),
                    ...
                    b.setLineDash &&
                      (n[h].lineDashType
                        ? ((z = n[h].lineDashType),
                          ...
                          b.setLineDash(g[g.length - 1].newLineDashArray))
                        : ((z = l.lineDashType),
                          (g[g.length - 1].newLineDashArray = E),
                          b.setLineDash(E))));
                  if (
                    0 !== n[h].markerSize &&
                    (0 < n[h].markerSize || 0 < l.markerSize)
                  ) {
                    var aa = l.getMarkerProperties(h, r, s, b);
                    f.push(aa);
                    var F = P(u);
                    w &&
                      f.push({
                    ...
                    aa = l.getMarkerProperties(h, r, m, b);
                    f.push(aa);
                    F = P(u);
                    w &&
                      f.push({
        ...
        if (0 < d.length) {
          ...
          if (0 < k.lineThickness) {
            ...
            for (var h = (f = 0); f < d.length - 3; f += 3, h++) {
              if (m[h].newStrokeStyle || m[h].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(d[f].x, d[f].y),
                  m[h].newStrokeStyle && (b.strokeStyle = m[h].newStrokeStyle),
                  m[h].newLineDashArray && b.setLineDash(m[h].newLineDashArray);
              b.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            ...
            for (h = !1; n < l.length; n++)
              if (
                ((q = l[n].x.getTime ? l[n].x.getTime() : l[n].x),
                !(
                ...
                if (
                  null !== l[n].y &&
                  l[n].y.length &&
                  "number" === typeof l[n].y[0] &&
                  "number" === typeof l[n].y[1]
                ) {
                  q = a.axisX.convertValueToPixel(q);
                  h = a.axisY.convertValueToPixel(l[n].y[0]);
                  ...
                  n < l.length - 1 &&
                    (A !== (l[n].lineColor || x) ||
                      C !== (l[n].lineDashType || k.lineDashType)) &&
                    ((A = l[n].lineColor || x),
                    (m[m.length - 1].newStrokeStyle = A),
                    b.setLineDash &&
                      (l[n].lineDashType
                        ? ((C = l[n].lineDashType),
                          (m[m.length - 1].newLineDashArray = N(
                            C,
                            k.lineThickness
                          )))
                        : ((C = k.lineDashType),
                          (m[m.length - 1].newLineDashArray = D))));
                  if (
                    0 !== l[n].markerSize &&
                    (0 < l[n].markerSize || 0 < k.markerSize)
                  ) {
                    var E = k.getMarkerProperties(n, q, h, b);
                    f.push(E);
                    var Q = P(y);
                    w &&
                      f.push({
                    ...
                    E = k.getMarkerProperties(n, q, r, b);
                    f.push(E);
                    Q = P(y);
                    w &&
                      f.push({
                  ...
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !l[n - 1].lineDashType) &&
                        ((m[m.length - 1].newLineDashArray = z),
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[p].getTime ? (l = v[p].x.getTime()) : (l = v[p].x),
                "number" !== typeof v[p].y)
              ) {
                ...
                var Q = v[p].color
                  ...
                  ? s.risingColor
                  : s.fallingColor;
                ca(c, t, g, E, k, Q, 0, Q, A, A, !1, !1, s.fillOpacity);
                e = P(e);
                w &&
                  ca(
                    this._eventManager.ghostCtx,
    ...
    var W = function (a, d, c, b, e, f, p, g, m) {
      if (!(0 > c)) {
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (k && l) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < l.length; e++) {
            var f = l[e],
              p = k.dataPointIds[e];
            h[e].id = p;
            ...
            if (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) {
              if (0 === a || h[c].midAngle > g.midAngle) c = e;
              a++;
            } else if (
              g.midAngle > (3 * Math.PI) / 2 - u &&
              g.midAngle < (3 * Math.PI) / 2 + u
            ) {
              if (0 === b || h[d].midAngle > g.midAngle) d = e;
              b++;
            }
            g.hemisphere =
              f > Math.PI / 2 && f <= (3 * Math.PI) / 2 ? "left" : "right";
            g.indexLabelTextBlock = new ia(m.plotArea.ctx, {
      ...
      function c(a) {
        ...
        for (b = 0; b < l.length; b++) {
          var c = h[b].startAngle,
            d = h[b].endAngle;
          if (d > c) {
            var e = 0.07 * z * Math.cos(h[b].midAngle),
              f = 0.07 * z * Math.sin(h[b].midAngle),
              p = !1;
            if (l[b].exploded) {
              if (
                1e-9 < Math.abs(h[b].center.x - (A.x + e)) ||
                1e-9 < Math.abs(h[b].center.y - (A.y + f))
              )
                (h[b].center.x = A.x + e * a),
                  (h[b].center.y = A.y + f * a),
                  (p = !0);
            } else if (
              0 < Math.abs(h[b].center.x - A.x) ||
              0 < Math.abs(h[b].center.y - A.y)
            )
              (h[b].center.x = A.x + e * (1 - a)),
                (h[b].center.y = A.y + f * (1 - a)),
                (p = !0);
            p &&
              ((e = {}),
              (e.dataSeries = k),
            ...
            W(
              ...
              h[b].center,
              h[b].radius,
              l[b].color ? l[b].color : k._colorSet[b % k._colorSet.length],
              k.type,
              c,
              d,
              k.fillOpacity,
      ...
      function e(a) {
        for (var c = null, d = 1; d < l.length; d++)
          if (
            ((c = (a + d + h.length) % h.length),
            ...
            (0 > b(h[c], h[a]) ||
              ("right" === h[a].hemisphere
                ? h[c].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y
                : h[c].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))
          )
            break;
          else c = null;
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < l.length) {
          var n = h[a];
          if (
            (0 > c && n.indexLabelTextBlock.y < p) ||
            (0 < c && n.indexLabelTextBlock.y > g)
          )
            return 0;
          var q = 0,
            t = 0,
          ...
          q = Math.sqrt(Math.pow(p - t, 2) + Math.pow(c - q, 2));
          t = Math.acos(z / w);
          q = Math.acos((w * w + z * z - q * q) / (2 * z * w));
          c = q < t ? c - n.indexLabelTextBlock.y : 0;
          p = null;
          ...
          k &&
            ...
            n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u
              ? ((p = (a - 1 + h.length) % h.length),
                ...
                "left" === n.hemisphere &&
                "right" === p.hemisphere &&
                c > p.indexLabelTextBlock.x
                  ? (c = p.indexLabelTextBlock.x - 15)
                  : "right" === n.hemisphere &&
                    "left" === a.hemisphere &&
      ...
      function p() {
        ...
        for (
            ...
            for (var t, u, a = 0; a < l.length; a++) {
              ...
              if (null !== s) {
                ...
                var C = 0,
                  C = b(t, u) - r;
                if (0 > C) {
                  for (var D = (u = 0), F = 0; F < l.length; F++)
                    F !== a &&
          ...
          (function () {
            for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < l.length; k++)
              if (((f = !1), (t = h[k]), t.indexLabelText)) {
                ...
                if (null !== p) {
                  ...
                  q
                    ? (0 > a && (a = k),
                      p !== a && ((c = p), (d += -C)),
                      0 === k % Math.max(l.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var D = 0; D < l.length; D++)
          (C += Math.abs(l[D].y)),
            !a &&
              "undefined" !== typeof l[D].indexLabel &&
              null !== l[D].indexLabel &&
              0 < l[D].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof l[D].label &&
              null !== l[D].label &&
              0 < l[D].label.toString().length &&
              (a = !0);
        if (0 !== C) {
          a =
            a ||
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              b.fillRect(q.x1, q.y1, q.width, q.height);
              for (
                var b = h[0].startAngle + 2 * Math.PI * a, c = 0;
                c < l.length;
                c++
              ) {
                var d = 0 === c ? h[c].startAngle : e,
                  e = d + (h[c].endAngle - h[c].startAngle),
                  f = !1;
                e > b && ((e = b), (f = !0));
                var p = l[c].color
                  ? l[c].color
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === h) return -1;
        for (
          var p = (d[0] = 0), g = 0, l, n, b = b - a, p = !1, k = 0;
          k < x.length;
          k++
        )
      ...
      function p() {
        ...
        for (var d, e, f, h, k, p, l = 1, m = 0; m < 2 * l; m++) {
          for (
            var r = I.length - 1;
            0 <= r &&
            !(0 <= n(r) && n(r),
      ...
      function m(a, b, c) {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            v(d);
            J && ("inside" !== u.indexLabelPlacement ? l(d) : f(), r(d));
            1 <= c && (ha = !1);
          },
          null,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          if (-1 !== H) {
            ...
            J &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || y.animationEnabled || l(R),
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (m(y, -1, 500), v(y.plotArea.ctx || y.ctx));
              },
              easingFunction: K.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    m.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            var p = b.replace(/^data:[a-z\/]*;base64,/, ""),
              p = atob(p),
    ...
    m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        var p = "#percent",
          ...
          g = isNaN(m.total) ? g : m.total,
          p = isNaN(m.percent) ? p : m.percent;
        do {
          m = "";
          ...
          a = a.replace("#percent", ea(p, m, f._cultureInfo));
          a = a.replace(
            "#total",
            ea(
              g,
      ...
      for (var l = 0; l < this.dataSeries.length; l++) {
        ...
        if (n.dataPoints && n.dataPoints.length)
          if (
            ...
            h = this.chart.replaceKeywordsWithValue(h, n.dataPoints[0], n, l);
            q = {
              markerType: q,
              markerColor: r,
              text: h,
    ...
    F.prototype.render = function () {
      ...
      for (var g = 0, m = 0; m < p.length; m++) {
        for (var k = p[m], l = 0, n = 0; n < k.items.length; n++) {
          var q = k.items[n],
            h =
          ...
          this.ctx.restore();
          l = 0 < n ? Math.max(l, q.textBlock.height) : q.textBlock.height;
          this.chart.data[q.dataSeriesIndex].visible ||
    ...
    E.prototype.createLabels = function () {
      ...
      if (
        ...
        if (this.labels) {
          a = Math.ceil(b);
          for (
            var b = Math.ceil(this.intervalStartPosition), h = !1, c = b;
            c < this.viewportMaximum;
            c += a
          )
            if (this.labels[c]) h = !0;
            else {
              h = !1;
              break;
            }
      ...
      if ("normal" === e) {
        for (
          ...
          var G = 0,
            ...
            $ = 0;
          if (c && 0 < c.length)
            for (y = [], h = O = 0; h < c.length; h++)
              y.push(
                Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)
              ),
                (O += y[h]),
                (L += c[h] && !l.isNavigator ? c[h].margin : 0);
          else
          ...
          m = Math.round(
            f.x2 - $ - Z > l.width - n ? l.width - n : f.x2 - $ - Z
          );
          if (a && 0 < a.length)
            for (x = [], h = T = 0; h < a.length; h++)
              a[h] && (a[h].lineCoordinates = {}),
                (a[h].lineCoordinates.width = Math.abs(m - p)),
                a[h].title &&
          ...
          if (d && 0 < d.length)
            for (A = [], h = V = 0; h < d.length; h++)
              d[h] && (d[h].lineCoordinates = {}),
                (d[h].lineCoordinates.width = Math.abs(m - p)),
                d[h].title &&
                ...
                (V += A[h]),
                (W += d[h] && !l.isNavigator ? d[h].margin : 0);
          else
                ...
                !a[h] ||
                  ...
                  0 < g
                    ...
                    : a[h].viewportMaximum === a[h].maximum &&
                      ...
                      (0 < F && (p += F), 0 < g && (m -= g))),
                l.panEnabled
                  ? (T = s(l.sessionVariables.axisX.height)
                      ? (l.sessionVariables.axisX.height = T)
                      : l.sessionVariables.axisX.height)
                  : (l.sessionVariables.axisX.height = T),
                (g = Math.round(f.y2 - T - e + G)),
                (k = Math.round(f.y2)),
                (a[h].lineCoordinates.x2 = m),
                (a[h].lineCoordinates.width = m - p),
                ...
                d[h]._labels &&
                  ...
                  (u =
                    ...
                    (g.textBlock.height - g.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(g.textBlock.angle)))),
                l.panEnabled
                  ? (V = s(l.sessionVariables.axisX2.height)
                      ? (l.sessionVariables.axisX2.height = V)
                ...
                c[h] &&
                  ...
                  (L =
                    c[h]._labels && 0 < c[h]._labels.length
                      ? c[h]._labels[c[h]._labels.length - 1].textBlock.height /
                        2
                      : n),
                  (g = Math.round(
              ...
              b[h] &&
                ...
                (L =
                  b[h]._labels && 0 < b[h]._labels.length
                    ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2
                    : 0),
                (g = Math.round(
        ...
        for (N = []; 4 > w; ) {
          ...
          if (c && 0 < c.length)
            for (h = 0; h < c.length; h++)
              (c[h].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - T - W > l.width - 10 ? l.width - 10 : f.x2 - T - W
                )),
                c[h].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length &&
                ...
                (c[h].lineCoordinates.x2 = m),
                (c[h].lineCoordinates.width = Math.abs(m - p)),
                c[h].title &&
                  (c[h]._titleTextBlock.maxWidth =
                    0 < c[h].titleMaxWidth &&
          ...
          if (b && 0 < b.length)
            for (h = 0; h < b.length; h++)
              (b[h].lineCoordinates = {}),
                ...
                (b[h].lineCoordinates.x2 = m),
                (b[h].lineCoordinates.width = Math.abs(m - p)),
                b[h].title &&
                  (b[h]._titleTextBlock.maxWidth =
                    0 < b[h].titleMaxWidth &&
          ...
          if (l.panEnabled)
            for (h = 0; h < c.length; h++)
              n[h] = s(l.sessionVariables.axisY.height)
                ? (l.sessionVariables.axisY.height = n[h])
          ...
          if (c && 0 < c.length)
            for (h = c.length - 1; 0 <= h; h--)
              (g = Math.round(f.y2)),
                (k = Math.round(
                  f.y2 > c[h].chart.height ? c[h].chart.height : f.y2
                )),
                (c[h].lineCoordinates.y1 = g - (n[h] + c[h].margin + V)),
                (c[h].lineCoordinates.y2 = g - (n[h] + c[h].margin + V)),
                "inside" === c[h].labelPlacement &&
                  0 < h &&
                  ((c[h].lineCoordinates.y1 =
                    ...
                    ("inside" === c[h].tickPlacement ? c[h].tickLength : 0)),
                  (c[h].lineCoordinates.y2 =
                    c[h].lineCoordinates.y1 + c[h].lineThickness / 2)),
                (c[h].bounds = {
                  x1: p,
                  y1: g - (n[h] + V + c[h].margin),
                  x2: m,
                  y2: k - (V + c[h].margin),
                  width: m - p,
                  height: n[h],
          ...
          if (b && 0 < b.length)
            for (h = b.length - 1; 0 <= h; h--)
              b[h] &&
                ((g = Math.round(f.y1)),
                (k = Math.round(f.y1 + (z[h] + b[h].margin + G))),
                (b[h].lineCoordinates.y1 = k),
                (b[h].lineCoordinates.y2 = k),
                "inside" === b[h].labelPlacement &&
                  0 < h &&
            ...
            for (h = 0; h < a.length; h++) {
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - U > l.height - Math.max(L, 10)
                        ? l.height - Math.max(L, 10)
                        : f.y2 - U
                    )
                  : f.y2 > l.height - Math.max(L, 10)
                  ? l.height - Math.max(L, 10)
                  : f.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x1), (p = m - X));
              a[h].lineCoordinates = {
                x1: m - P,
                y1: g,
                x2: m - P,
            ...
            for (h = 0; h < d.length; h++) {
              ...
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((m = b[L].lineCoordinates.x2), (p = m - T));
              d[h].lineCoordinates = {
                x1: m + R,
                y1: g,
                x2: m + R,
          ...
          if (
            ...
            if ("outside" === c.stripLine.labelPlacement)
              if (
                ...
                this.ctx.beginPath();
                this.ctx.moveTo(l, a.y << 0);
                this.ctx.lineTo(l, (a.y + this.tickLength) << 0);
                this.ctx.stroke();
                0 === this.labelAngle
                ...
                "top" === this._position
                  ...
                  ? ((l =
                      1 === this.ctx.lineWidth % 2
                        ...
                        : a.y << 0),
                    this.ctx.beginPath(),
                    this.ctx.moveTo(a.x << 0, l),
                    this.ctx.lineTo((a.x - this.tickLength) << 0, l),
                    this.ctx.stroke(),
                    0 === this.labelAngle
                      ? (a.x =
                          a.x -
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(g, e),
                d.lineTo(g, this.scaleBreaks._appliedBreaks[m].startPixel + b),
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (m = (this.chart.plotArea.y2 + n / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (m = (this.chart.plotArea.y1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - n / 2, y1: e, x2: g + n / 2, y2: m }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, m), this.ctx.lineTo(g, m), this.ctx.lineTo(g, e);
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((b = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - n / 2, x2: g, y2: m + n / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(g, e), this.ctx.lineTo(g, m), this.ctx.lineTo(b, m);
          else if ("wavy" === this.type) {
            s = b;
            k = e;
            f = 0.5;
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: g, x2: f + d / 2, y2: m });
        else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
          (g = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: g - d / 2, x2: f, y2: m + d / 2 });
        this.ctx.moveTo(e, g);
        this.ctx.lineTo(f, m);
        this.ctx.stroke();
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var y = 0; y < this.parent.dataSeries.length; y++)
            (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
              ...
              null !== v.dataPoint.y && v.dataSeries.visible && l.push(v));
          v = null;
          if (0 === l.length) return;
          l.sort(function (a, b) {
            return a.distance - b.distance;
          });
          v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y));
          y = 0;
          if (
            "rangeBar" === l[0].dataSeries.type ||
            "error" === l[0].dataSeries.type
          )
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(l[y].dataPoint.y[0])
                ),
                u = 0,
                r = 0;
              r < l.length;
              ...
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (var x = 0; x < l[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r));
              else
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(l[r].dataPoint.y)
                )),
                  u < v && ((v = u), (y = r));
          else if ("stackedBar" === l[0].dataSeries.type)
            for (
              var v = Math.abs(
              ...
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r));
                ...
                (A += l[r].dataPoint.y),
                  ...
                  u < v && ((v = u), (y = r));
          else if ("stackedBar100" === l[0].dataSeries.type)
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(l[0].dataPoint.y)
                ),
              ...
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                ...
                (A += l[r].dataPoint.y),
                  (C = l[r].dataPoint.x.getTime
                    ? l[r].dataPoint.x.getTime()
                    : l[r].dataPoint.x),
                  (C = 100 * (A / l[r].dataSeries.plotUnit.dataPointYSums[C])),
          ...
          if (
            ...
            this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: g };
            ...
            this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: g + n / 2 };
            C = !1;
            if (this.parent.labels)
              for (
                l = Math.ceil(this.parent.interval), r = 0;
          ...
          y = 0;
          if (
            "rangeColumn" === l[0].dataSeries.type ||
            "rangeArea" === l[0].dataSeries.type ||
            "error" === l[0].dataSeries.type ||
            "rangeSplineArea" === l[0].dataSeries.type ||
            "candlestick" === l[0].dataSeries.type ||
            "ohlc" === l[0].dataSeries.type ||
            "boxAndWhisker" === l[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(l[0].dataPoint.y[0])
              ),
                r = u = 0;
              r < l.length;
              r++
              ...
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(l[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r));
              else
                (u = Math.abs(
                  d - this.parent.convertValueToPixel(l[r].dataPoint.y)
                )),
                  u < v && ((v = u), (y = r));
          else if (
            "stackedColumn" === l[0].dataSeries.type ||
            "stackedArea" === l[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(l[0].dataPoint.y)
              ),
                r = A = u = 0;
              r < l.length;
              r++
            ...
            "stackedColumn100" === l[0].dataSeries.type ||
            "stackedArea100" === l[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(l[0].dataPoint.y)
          ...
          if (
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y));
            A = u = 0;
            for (r = y; 0 <= r; r--)
              (A += l[r].dataPoint.y),
                (u = Math.abs(d - this.parent.convertValueToPixel(A))),
        ...
        "left" === this.parent._position && k.x < this.chart.bounds.x1
          ...
          : "bottom" === this.parent._position &&
            ...
            (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
        0 < n &&
          (q.moveTo(b, f), q.lineTo(e, g), q.stroke(), (this._hidden = !1));
        q.restore();
        !s(k.text) &&
          ("number" === typeof k.text.valueOf() || 0 < k.text.length) &&
          k.render(!0);
    ...
    X.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (0 < f.length) {
          ...
          if (this.enabled) {
            var l = "",
              l = this.getToolTipInnerHTML({ entries: f });
            if (null !== l) {
          ...
          this._entries = f;
          this.dispatchEvent("updated", l, this);
        } else this.hide();
      }
    };
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", g = !0, m = 0;
        m < a.length;
        m++
      )
    ...
    var K = {
      ...
      V = {
        drawMarker: function (a, d, c, b, e, f, g, m) {
          if (c) {
            var s = 1;
